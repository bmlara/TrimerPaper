...
\begin{abstract}
We study electromagnetic field propagation through a general three-waveguide coupler  using a symmetry based approach to take advantage of the underlying $SU(3)$ symmetry.
\end{abstract}
